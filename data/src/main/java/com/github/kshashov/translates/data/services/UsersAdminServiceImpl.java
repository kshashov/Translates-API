...
import com.github.kshashov.translates.common.errors.IncorrectArgumentException;
...
public class UsersAdminServiceImpl implements UsersAdminService {
    ...
    public UsersAdminServiceImpl(RolesRepository rolesRepository, UsersRepository usersRepository) {
        ...
        this.userRole = rolesRepository.findOneByCode(RoleType.USER.getCode());
        this.adminRole = rolesRepository.findOneByCode(RoleType.ADMIN.getCode());
    }
